...
class PlayerJoinEventTrigger(private val eventManager: EventManager) :
    ChannelListener(RedisChannels.VULPESCLOUD_EVENT_PLAYER_PlayerJoinEvent.name) {
    ...
    override fun onMessage(message: String) {
        ...
        eventManager.callLocal(PlayerJoinEvent(getPlayer(event.getJSONObject("player"))))
    }
}
