...
class ModuleProvider {
    ...
    private val moduleJsonURL =
        URI("https://raw.githubusercontent.com/VulpesCloud/VulpesCloud-meta/refs/heads/main/modules.json").toURL()
    ...
    fun loadAllModules() {
        ...
        if (this.loadedModules.isNotEmpty()) {
            this.loadedModules.forEach {
                ...
                it.module.enable()
                it.moduleInfo.state = ModuleStates.STARTED
            }
        }
    }
    ...
    fun unloadAllModules() {
        this.loadedModules.forEach {
            ...
            it.module.disable()
            it.moduleInfo.state = ModuleStates.STOPPED
        }
    }
}