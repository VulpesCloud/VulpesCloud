...
class InfoCommand {
    ...
    fun displayInfo(
        ...
        source.sendMessage("Java&8: &f${runtimeMXBean.vmVendor} ${runtimeMXBean.specVersion} &8[&f ${runtimeMXBean.vmName} ${runtimeMXBean.vmVersion} &8]")
        source.sendMessage("-----------------------------------------------------")
        ...
        source.sendMessage("------------------------------------------------------")
        source.sendMessage("Uptime&8: &f${(System.currentTimeMillis() - System.getProperty("startup").toLong()) / 1000 } seconds")
    }
